  ...
  return (
    <main className={styles.main}>
        <div className={styles.intro}>
            ...
            <div>2년차 프론트엔드 개발자입니다. 저는 잘 하는 프론트엔드 개발자가 백엔드와의 API 연동을 문제없이 하는 것뿐 아니라 사용자가 더욱 페이지에 머무르고 싶도록 만드는 것이 역량이라고 생각합니다. 사용자 경험에 해가 되는 무분별한 이벤트는 지양해야겠지만, 사용할 맛이 나도록 만드는 것이 목표입니다.</div>
        </div>
